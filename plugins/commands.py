...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            InlineKeyboardButton('📍 ᴛᴠ ꜱᴇʀɪᴇꜱ 📍', url='https://t.me/infinitytvseries')
            ],
            [
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        try:
            ...
            logger.error("හායි මුලින්ම අපේ Updates Channel එකට ජොයින් වෙලා ඉන්න...!")
            return
        btn = [
            [
                InlineKeyboardButton(
                    "⭕ ᴊᴏɪɴ ɪɴꜰɪɴɪᴛʏ ᴍᴏᴠɪᴇ ⭕", url=invite_link.invite_link
                )
            ],
             [
                InlineKeyboardButton(
                    "🧪 ᴊᴏɪɴ ɪɴꜰɪɴɪᴛʏ ᴛᴠ ꜱᴇʀɪᴇꜱ  🧪", url='https://t.me/sinhalafilx'
                )
            ]
        ]
        ...
        await client.send_message(
            ...
            text="**මුලින්ම අපේ Update Channel එකට ජොයින් වෙලා ඉට පස්සේ Try Again දෙන්න!**",
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('♥️ Thank You Nimsara ♥️')
